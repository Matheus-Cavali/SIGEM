...
public class CategoriaEventoControl {
    ...
    private static CategoriaEvento categoriaEvento;
    private final Gson gson = new Gson();

    public static synchronized CategoriaEvento getCategoriaEvento(){
    ...
    public Resposta cadastrar(String auth, String json){
        ...
        try{
            ...
            getCategoriaEvento().cadastrar(Conexao.getConexao(), ce);
    ...
    public Resposta listar(String query){
        ...
        try{
            ...
            List<CategoriaEvento> lista =
                    getCategoriaEvento().filtrar(Conexao.getConexao(), nome);
    ...
    public Resposta atualizar(String auth, int id, String json){
        ...
        try{
            ...
            getCategoriaEvento().alterar(Conexao.getConexao(), ce);
    ...
    public Resposta excluir(String auth, int id){
        ...
        try{
            getCategoriaEvento().excluir(Conexao.getConexao(), id);
